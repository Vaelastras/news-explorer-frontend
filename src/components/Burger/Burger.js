...
function Burger(props) {
  ...
  const crossButtonDark = `${pathname === '/saved-news' && props.isOpenBurgerMenu ? 'burger__button-cross_type_dark' : ''}`;
  const crossBurgerColorDark = `${pathname === '/saved-news' && !props.isOpenBurgerMenu ? 'burger__button_type_dark' : ''}`;
